...
const DEMO_SEED_MEMOS_ZH = [
  ...
  {
    id: "memo_demo_code_highlighting",
    notebookId: "nb_demo_features",
    title: "代码高亮：常见语言示例",
    ...
    markdown: [
      "## 代码高亮：常见语言示例",
      "",
      "这条笔记用于体验常见编程语言、配置格式和标记语言的语法高亮效果。每个代码块都保留了语言标识。",
      "",
      "### JavaScript / TypeScript",
      "",
      "```javascript",
      "const greet = (name = \"World\") => `Hello, ${name}!`;",
      "console.log(greet(\"EdgeEver\"));",
      "```",
      "",
      "```typescript",
      ...
      "        System.out.println(\"Hello, EdgeEver!\");",
      "    }",
      "}",
      "```",
      "",
      ...
      "package main",
      "import \"fmt\"",
      "func main() { fmt.Println(\"Hello, EdgeEver!\") }",
      "```",
      "",
      "```rust",
      "fn main() { println!(\"Hello, EdgeEver!\"); }",
      "```",
      "",
      "### C / C++ / C#",
      "",
      "```c",
      "#include <stdio.h>",
      "int main(void) { printf(\"Hello, EdgeEver!\\n\"); return 0; }",
      "```",
      "",
      "```cpp",
      "#include <iostream>",
      "int main() { std::cout << \"Hello, EdgeEver!\" << std::endl; }",
      "```",
      "",
      "```csharp",
      "Console.WriteLine(\"Hello, EdgeEver!\");",
      "```",
      "",
      "### PHP / Ruby / Swift / Kotlin",
      "",
      "```php",
      "<?php echo \"Hello, EdgeEver!\"; ?>",
      "```",
      "",
      "```ruby",
      "puts \"Hello, EdgeEver!\"",
      ...
      "",
      "```kotlin",
      "fun main() { println(\"Hello, EdgeEver!\") }",
      "```",
      "",
      "### Shell / SQL / Web",
      "",
      "```bash",
      "set -euo pipefail",
      "for file in *.md; do echo \"Checking: $file\"; done",
      "```",
      "",
      "```sql",
      "SELECT title FROM notes WHERE is_deleted = 0 ORDER BY updated_at DESC;",
      "```",
      "",
      "```html",
      "<article class=\"note-card\"><h2>代码高亮</h2></article>",
      "```",
      "",
      "```css",
      ".note-card { color: #1f2937; display: grid; gap: 0.75rem; }",
      "```",
      "",
      "### JSON / YAML / Markdown / Mermaid",
      "",
      "```json",
      "{ \"name\": \"edgeever-demo\", \"highlighting\": true }",
      "```",
      "",
      "```yaml",
      "app:",
...
const DEMO_MEMO_ENGLISH = {
  ...
  memo_demo_code_highlighting: {
    title: "Code Highlighting: Common Languages",
    markdown: [
      "## Code Highlighting: Common Languages",
      "",
      "Preview syntax highlighting for common programming languages, configuration formats, and markup languages. Each fenced block keeps its language identifier.",
      "",
      "### JavaScript / TypeScript",
      "",
      "```javascript",
      ...
      "",
      "```html",
      "<article class=\"note-card\"><h2>Code highlighting</h2></article>",
      "```",
      "",
      "```css",
      ".note-card { color: #1f2937; display: grid; gap: 0.75rem; }",
      ...
      "```mermaid",
      "flowchart LR",
      "  A[Open note] --> B{Code block?}",
      "  B -->|Yes| C[View highlighting]",
      "  B -->|No| D[Keep editing]",
      "```",
    ].join("\n"),
  },
